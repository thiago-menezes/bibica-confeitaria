      ...
      <div className="container px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex items-center space-x-2">
            <Image src="/bibica-logo.png" alt="Bibica Cozinha Gourmet" width={100} height={32} className="h-8 w-auto" />
          </div>
          ...
          <p className="text-sm text-muted-foreground">© 2024 Bibica Cozinha Gourmet. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
